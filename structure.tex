...
\newcommand{\CVCertificate}[5]{ % New command for a data record
\textbf{#1}\hfill\textit{#5}\par
\textbf{\color{RoyalBlue}\textit{#2}}\hfill\textbf{\color{RoyalBlue} #3}\par
#4
\Sep % Used for spacing
...
\newcommand{\CVCooperation}[6]{ % New command for a data record
...
\newcommand{\CVContribution}[5]{ % New command for a data record
